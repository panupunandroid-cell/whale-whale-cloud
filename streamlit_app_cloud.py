...
with tab_summary:
    ...
    if daily.empty:
        ...
        if not filtered.empty:
            ...
            weekday_colors = {
                0: "#FFFFCC",  # จันทร์ เหลืองอ่อน
                1: "#FF99CC",  # อังคาร ชมพูอ่อน
                2: "#66FF66",  # พุธ เขียวอ่อน
                3: "#FF6633",  # พฤหัสฯ ส้มอ่อน
                4: "#99FFFF",  # ศุกร์ ฟ้าอ่อน
                5: "#CC99FF",  # เสาร์ ม่วงอ่อน
                6: "#FF3333",  # อาทิตย์ แดงอ่อน
            }
            table_rows = ""
